...
public final class SinkTestStep extends TableTestStep {
    ...
    public final @Nullable List<Row> expectedBatchRows;
    public final @Nullable List<String> expectedBatchStrings;
    ...
    SinkTestStep(
            ...
            @Nullable List<Row> expectedBatchRows,
            @Nullable List<String> expectedBatchStrings,
        ...
        this.expectedBatchRows = expectedBatchRows;
        this.expectedBatchStrings = expectedBatchStrings;
    ...
    public List<String> getExpectedBatchResultsAsStrings() {
        if (expectedBatchStrings != null) {
            return expectedBatchStrings;
        }
        if (expectedBatchRows != null) {
            return expectedBatchRows.stream().map(Row::toString).collect(Collectors.toList());
        }
